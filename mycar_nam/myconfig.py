...
AUG_BLUR_RANGE = 3
# 
AUG_CUTOUT_HOLES = 10      # Số lượng ô vuông trắng ngẫu nhiên ném vào ảnh
AUG_CUTOUT_SIZE = 20       # Kích thước tối đa của mỗi ô vuông (pixel)
AUG_CUTOUT_FILL = 255      # Màu để che. 255 là màu TRẮNG. 
                           # Vì đề bài nói nền trắng, vạch đen bị che bởi màu trắng/khác.
                           # Để 255 giúp model học cách: "Chỗ này trắng bóc, mất vạch rồi, tự nội suy đi"
# # "CROP" Transformation
...
JOYSTICK_MAX_THROTTLE = 0.22         #this scalar is multiplied with the -1 to 1 throttle value to limit the maximum throttle. This can help if you drop the controller or just don't need the full speed available.
...
BEHAVIOR_LIST = [
    'Normal',           # State 0: Đi thẳng, bám làn (dùng cho ngã 3 đầu tiên, cầu xanh)
    'Left_Turn',        # State 1: Rẽ trái (dùng cho ngã 3 thứ 2, 3, 5)
    'Obstacle_Avoid'    # State 2: Né vật cản (dùng khi phát hiện xe chiếm làn)
]

# Tăng Batch Size để model học tổng quát tốt hơn (nếu Pi hoặc PC train đủ mạnh)
